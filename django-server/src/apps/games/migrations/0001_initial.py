    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_genre', models.TextField(blank=True, db_column='type', null=True, verbose_name='Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fk_game', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='games.Game')),
        ...
        migrations.AddField(
            model_name='game',
            name='knowers',
            field=models.ManyToManyField(related_name='known_games', through='games.Knower', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='game',
            name='owners',
            field=models.ManyToManyField(related_name='owned_games', through='games.Owner', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AlterUniqueTogether(
            name='owner',
            unique_together=set([('fk_game', 'fk_player')]),
        ),
        migrations.AlterUniqueTogether(
            name='knower',
            unique_together=set([('fk_game', 'fk_player')]),
